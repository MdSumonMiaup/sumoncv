...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'sumoncv' ),
        'hover'    => esc_html__( 'Hover', 'sumoncv' ),
        'active'   => esc_html__( 'Active', 'sumoncv' ),
        'visited'  => esc_html__( 'Visited', 'sumoncv' ),
        'focus'    => esc_html__( 'Focus', 'sumoncv' )
      );
