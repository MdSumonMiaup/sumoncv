      ...
      echo '<div class="csf--typography'. esc_attr( $chosen_class ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';
        ...
        echo '<div class="csf--blocks csf--blocks-selects">';
          ...
          if ( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Family', 'sumoncv' ) .'</div>';
            echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'sumoncv' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Backup Font Family', 'sumoncv' ) .'</div>';
            echo $this->create_select( apply_filters( 'csf_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'sumoncv' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Style', 'sumoncv') .'</div>';
            echo '<select class="csf--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'sumoncv' ) : '' ) .'</option>';
            ...
            if ( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="csf--title">'. esc_html__( 'Load Extra Styles', 'sumoncv' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'sumoncv' ) : esc_html__( 'Default', 'sumoncv' );
          ...
          if ( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Subset', 'sumoncv' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'sumoncv' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Align', 'sumoncv' ) .'</div>';
            echo $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'sumoncv' ),
              'left'    => esc_html__( 'Left', 'sumoncv' ),
              'center'  => esc_html__( 'Center', 'sumoncv' ),
              'right'   => esc_html__( 'Right', 'sumoncv' ),
              'justify' => esc_html__( 'Justify', 'sumoncv' ),
              'initial' => esc_html__( 'Initial', 'sumoncv' )
            ), 'text-align', esc_html__( 'Default', 'sumoncv' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Variant', 'sumoncv' ) .'</div>';
            echo $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'sumoncv' ),
              'small-caps'     => esc_html__( 'Small Caps', 'sumoncv' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'sumoncv' )
            ), 'font-variant', esc_html__( 'Default', 'sumoncv' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Transform', 'sumoncv' ) .'</div>';
            echo $this->create_select( array(
              'none'       => esc_html__( 'None', 'sumoncv' ),
              'capitalize' => esc_html__( 'Capitalize', 'sumoncv' ),
              'uppercase'  => esc_html__( 'Uppercase', 'sumoncv' ),
              'lowercase'  => esc_html__( 'Lowercase', 'sumoncv' )
            ), 'text-transform', esc_html__( 'Default', 'sumoncv' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Decoration', 'sumoncv' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'sumoncv' ),
              'underline'          => esc_html__( 'Solid', 'sumoncv' ),
              'underline double'   => esc_html__( 'Double', 'sumoncv' ),
              'underline dotted'   => esc_html__( 'Dotted', 'sumoncv' ),
              'underline dashed'   => esc_html__( 'Dashed', 'sumoncv' ),
              'underline wavy'     => esc_html__( 'Wavy', 'sumoncv' ),
              'underline overline' => esc_html__( 'Overline', 'sumoncv' ),
              'line-through'       => esc_html__( 'Line-through', 'sumoncv' )
            ), 'text-decoration', esc_html__( 'Default', 'sumoncv' ) );
            echo '</div>';
          }
        ...
        echo '<div class="csf--blocks csf--blocks-inputs">';
          ...
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Size', 'sumoncv' ) .'</div>';
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Line Height', 'sumoncv' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Letter Spacing', 'sumoncv' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Word Spacing', 'sumoncv' ) .'</div>';
            echo '<div class="csf--input-wrap">';
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Font Color', 'sumoncv' ) .'</div>';
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Custom Style', 'sumoncv' ) .'</div>';
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        if ( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'sumoncv' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'sumoncv' ),
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'sumoncv' ),
