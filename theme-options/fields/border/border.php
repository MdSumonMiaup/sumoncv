  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'sumoncv' ),
        'right_placeholder'  => esc_html__( 'right', 'sumoncv' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'sumoncv' ),
        'left_placeholder'   => esc_html__( 'left', 'sumoncv' ),
        'all_placeholder'    => esc_html__( 'all', 'sumoncv' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'sumoncv' ),
        'dashed'    => esc_html__( 'Dashed', 'sumoncv' ),
        'dotted'    => esc_html__( 'Dotted', 'sumoncv' ),
        'double'    => esc_html__( 'Double', 'sumoncv' ),
        'inset'     => esc_html__( 'Inset', 'sumoncv' ),
        'outset'    => esc_html__( 'Outset', 'sumoncv' ),
        'groove'    => esc_html__( 'Groove', 'sumoncv' ),
        'ridge'     => esc_html__( 'ridge', 'sumoncv' ),
