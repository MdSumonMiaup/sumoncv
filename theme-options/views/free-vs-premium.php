...
<table class="csf--table-compare widefat fixed striped">
  ...
  <tfoot>
    <tr>
      <td></td>
      <td><a href="<?php echo esc_url('https://github.com/Codestar/codestar-framework/'); ?>" class="button" target="_blank" rel="nofollow">Download Free Version</a></td>
      <td><a href="<?php echo esc_url('http://codestarframework.com/'); ?>" class="button button-primary" target="_blank" rel="nofollow">Upgrade Premium Version</a></td>
    </tr>
  </tfoot>
</table>
