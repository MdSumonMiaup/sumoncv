...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <h1>Welcome to Codestar Framework v<?php echo esc_html( CSF::$version ); ?></h1>

  <p class="csf-about-text">A Simple and Lightweight WordPress Option Framework for Themes and Plugins</p>

  <p class="csf-demo-button"><a href="<?php echo esc_url( add_query_arg( array( 'csf-demo' => $status ) ) ); ?>" class="button button-primary<?php echo esc_attr( $class ); ?>"><?php echo esc_html( $text ); ?> Demo</a></p>
  ...
  <div class="csf-logo">
    ...
    <div class="csf--text csf--version">v<?php echo esc_html( CSF::$version ); ?></div>
  </div>
  ...
  <h2 class="nav-tab-wrapper wp-clearfix">
    <?php
      ...
      foreach ( $links as $key => $link ) {
        ...
        echo '<a href="'. esc_url( add_query_arg( array( 'page' => 'csf-welcome', 'section' => $key ), admin_url( 'tools.php' ) ) ) .'" class="nav-tab'. esc_attr( $activate ) .'">'. esc_html( $link ) .'</a>';
