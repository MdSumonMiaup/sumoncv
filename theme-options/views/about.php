...
<div class="csf-welcome-cols">
  ...
  <div class="csf--col-upgrade">
    <a href="<?php echo esc_url('http://codestarframework.com/'); ?>" class="button button-primary" target="_blank" rel="nofollow"><i class="fas fa-share"></i> Upgrade Premium Version</a>
  </div>
  <?php } ?>
